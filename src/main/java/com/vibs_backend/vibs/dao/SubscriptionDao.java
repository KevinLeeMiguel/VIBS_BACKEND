...
public interface SubscriptionDao extends JpaRepository<Subscription,String>{
    ...
    public List<Subscription> findByVehiclePlateNoAndStatusAndPaymentStatusAndDeletedStatus(String vid,SubscriptionStatus status,boolean pstatus, boolean deletedStatus);
    //analytics
